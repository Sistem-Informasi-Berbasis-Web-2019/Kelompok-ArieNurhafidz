        ...
        <div class="container text-center pt-3" align = "center">
            <a href='/aplikasi_daftar_tamu/admin.php'>
               ...
               <div class="container text-center pt-10">
                <a class="btn btn-outline-primary btn-lg" href="edit_runtext.php"> EDIT RUNTEXT </a>
                <a class="btn btn-outline-primary btn-lg" href="edit_profile.php"> EDIT GAMBAR </a>
                <a class="btn btn-outline-primary btn-lg" href="edit_password.php"> EDIT PASSWORD </a>
            </div>
